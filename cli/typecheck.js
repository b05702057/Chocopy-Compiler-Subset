...
function newTypeEnv() {
    return { vars: new Map(),
        funcs: new Map(), retType: ast_1.Type.none };
}
    ...
    switch (expr.op) {
        case ast_1.UniOp.Minus:
            ...
            if (typedExpr.a !== ast_1.Type.int) {
                throw new Error("TYPECHECK ERROR: uniary operator " + ast_1.UniOp.Minus + " expected " + ast_1.Type.int + "; got type " + typedExpr.a);
            }
        ...
        case ast_1.UniOp.Not:
            ...
            if (notTypedExpr.a !== ast_1.Type.bool) {
                throw new Error("TYPECHECK ERROR: uniary operator " + ast_1.UniOp.Not + " expected " + ast_1.Type.bool + "; got type " + notTypedExpr.a);
            }
